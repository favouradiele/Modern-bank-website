    ...
    >
      ...
      <div className="flex flex-row justify-between items-center w-full">
        ...
        >
          ...
          <span className="text-gradient">Generational</span>{" "}
        </h1>
      ...
      >Payment Method.</h1>
        ...
        <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
          ...
          iure beatae culpa et quia explicabo corporis dignissimos, cum laborum.
          Amet magnam repellat, numquam accusamus quam pariatur vel eveniet
          obcaecati!
        </p>
